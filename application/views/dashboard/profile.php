                           ...
                           <div class="accordion-content">
                              ...
                              <p>
                                 ...
                                 <ul class="share-icons">
                                    <li>
                                       <a class="fb" href="https://facebook.com/sharer.php?u=http://gunsalefinder.com/promotion/facebook/<?php echo $userid; ?>" target="_blank">
                                    ...
                                    <li>
                                       <a class="googleplus" href="https://plus.google.com/share?url=<?php echo rawurlencode('http://www.gunsalefinder.com/promotion/googleplus/'.$userid); ?>" target="_blank"><i class="fa fa-google-plus"></i></a><span>Google+</span>
                                    </li>
                                 </ul>
                              </div>
                              </p>
